...
Ao longo do repositório, é possível encontrar desde aplicações simples, voltadas ao entendimento dos conceitos iniciais do framework, até projetos um pouco mais completos, que envolvem **CRUD**, integração com **APIs**, uso de **Angular Material** e persistência de dados no **Local Storage**. Cada aplicação foi pensada para reforçar conceitos essenciais e simular cenários próximos aos encontrados em projetos reais. Com o desenvolvimento contínuo, novas funcionalidades e ajustes foram incorporados, reforçando a evolução prática dos conceitos estudados.
...
> De forma geral, este repositório representa minha base de aprendizado em Angular, consolidando conceitos essenciais do framework e preparando o caminho para projetos mais avançados. O último commit incorporou novos recursos e ajustes nos projetos, refletindo a continuidade do aprendizado e o aprofundamento nas práticas do framework.
